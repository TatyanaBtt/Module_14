...
async def get_buying_list(message):
    await message.answer("Название: Продукт 1 | Описание: описание 1 | Цена: 100")
    with open('vit_C.jpeg', "rb") as img:
        await message.answer_photo(img)
    await message.answer("Название: Продукт 2 | Описание: описание 2 | Цена: 200")
    with open('vit_D.jpg', "rb") as img:
        await message.answer_photo(img)
    await message.answer("Название: Продукт 3 | Описание: описание 3 | Цена: 300")
    with open('vit_Mg.jpg', "rb") as img:
        await message.answer_photo(img)
    await message.answer("Название: Продукт 4 | Описание: описание 4 | Цена: 400")
